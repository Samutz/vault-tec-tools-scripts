Scriptname SV88:RecInt01_StallScript extends ObjectReference
...
Group GlobalVariable
	GlobalVariable Property kgSIM_Performance_SoundEmitters Auto Const Mandatory
...
Function PlayOnActivateSound()
	if kgSIM_Performance_SoundEmitters.GetValue() == 1.0 && !bIsCWSS
		Utility.Wait(3)
