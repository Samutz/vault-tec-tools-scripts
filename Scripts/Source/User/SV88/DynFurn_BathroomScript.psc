Scriptname SV88:DynFurn_BathroomScript extends ObjectReference
...
Function SpawnLevelItems()
	...
	while i < LevelSpawnItems.length
		if !(LevelSpawnItems[i].FormToSpawn as FormList)
			ObjectReference spawnRef = SV88:SamutzLibrary.PlaceRelativeToMe(Self, LevelSpawnItems[i].FormToSpawn, LevelSpawnItems[i].fOffsetX, LevelSpawnItems[i].fOffsetY, LevelSpawnItems[i].fOffsetZ, LevelSpawnItems[i].fRotationX, LevelSpawnItems[i].fRotationY, LevelSpawnItems[i].fRotationZ, LevelSpawnItems[i].fScale)
	...
	while i < LevelSpawnItems.length
		if (LevelSpawnItems[i].FormToSpawn as FormList)
			if (LevelSpawnItems[i].FormToSpawn as FormList).GetSize() > 0
				...
				ObjectReference spawnRef = SV88:SamutzLibrary.PlaceRelativeToMe(Self, FormToSpawn, LevelSpawnItems[i].fOffsetX, LevelSpawnItems[i].fOffsetY, LevelSpawnItems[i].fOffsetZ, LevelSpawnItems[i].fRotationX, LevelSpawnItems[i].fRotationY, LevelSpawnItems[i].fRotationZ, LevelSpawnItems[i].fScale)
