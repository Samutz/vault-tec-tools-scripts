...
; N/A
; ---------------------------------------------
Scriptname SV88:ManagementQuestScript extends Quest
...
Group DEPRECATED
	FormList Property LampFormList Auto Const
	{only still here so it can be reverted after upgrade}
EndGroup
...
Group Settings
	...
	GlobalVariable Property kgSIM_PipboySoftwareInstalled Auto Const
EndGroup
...
string LogName = "SV88_ManagementQuestScript"
...
Function CheckForSSInstall()
	...
	if kgSIM_PipboySoftwareInstalled.GetValue() == 1.0
		Startup()
	else
...
Function RestartDoorManager()
	if DoorManager.IsRunning()
		DoorManager.Stop()
	endIf
	DoorManager.Start()
EndFunction
